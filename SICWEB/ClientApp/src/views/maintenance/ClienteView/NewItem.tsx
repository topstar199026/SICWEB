...
const NewItem: FC<NewItemProps> = ({
    ...
    const _getCargo: any = (_c) => {
        let _cargo = '';
        for(let i=0; i<cargo.length; i++)if(cargo[i].cli_contac_cargo_c_yid.toString() === _c.toString()) _cargo = cargo[i].cli_contac_cargo_c_vnomb;
        console.log(_c, cargo, _cargo)
        return _cargo;
    }
    ...
    const addContact = (contact: any) => {
        ...
        const _c = contacts;
        console.log('contactcc',_c);
        _c.push(contact);
        console.log('contactcccc',_c);
        setContacts([..._c]);
    }
        ...
        <>
            <Formik
                ...
                validationSchema={Yup.object().shape({
                    ...
                    .of(
                        Yup.object().shape({
                            value: Yup.string().max(200, 'Debe tener 200 caracteres como máximo').required('Se requiere una Nombre Comercial'),
                        })
                    )
                    ...
                    .of(
                        Yup.object().shape({
                            value: Yup.string().max(200, 'Debe tener 200 caracteres como máximo').required('Se requiere una Nombre Comercial'),
                            department: Yup.number().min(0, 'Se requiere el tipo de Departamento').required('Se requiere el tipo de Departamento'),
                            province: Yup.number().min(0, 'Se requiere el tipo de Provincia').required('Se requiere el tipo de Provincia'),
                            district: Yup.number().min(0, 'Se requiere el tipo de Distrito').required('Se requiere el tipo de Distrito'),
                            kind: Yup.number().min(0, 'Se requiere el tipo de tipo').required('Se requiere el tipo de tipo'),
                        })
                    )
                    .required('Must have Nombre Comercial')
                    .min(1, 'Minimum of 1 Nombre Comercial'),
            ...
            >
                {({
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Box p={3}>            
                            <Grid container spacing={3}>
                                <Grid item xl={4} lg={4} md={4} sm={4} xs={12}>
                                    <TextField
                                        size="small"
                                        label={<label>Tipo de persona <span style={{color: 'red'}}>*</span></label>}
                                        name="person"
                                        error={Boolean(touched.person && errors.person)}
                                        helperText={touched.person && errors.person && 'Se requiere el tipo de persona'}
                                        fullWidth
                                        select
                                ...
                                <Grid item xl={4} lg={4} md={4} sm={4} xs={12}>
                                    <TextField
                                        ...
                                        label={<label>Razón Social <span style={{color: 'red'}}>*</span></label>}
                                        InputLabelProps={{
                                            shrink: true
                                        }}
                                        name="company"
                                ...
                                <Grid item xl={4} lg={4} md={4} sm={4} xs={12}>
                                    <TextField
                                        ...
                                        label={<label>RUC <span style={{color: 'red'}}>*</span></label>}
                                        InputLabelProps={{
                                            shrink: true
                                        }}
                                        name="ruc"
                                                                ...
                                                                values.trade.map((_trade, index) => (
                                                                    <Grid key={index} item xl={12} xs={12}>
                                                                        <TextField
                                                                            size="small"
                                                                            error={Boolean(
                                                                                touched.trade && touched.trade[index] && touched.trade[index].value &&
                                                                                errors.trade && errors.trade[index] && errors.trade[index]
                                                                            )}
                                                                            fullWidth
                                                                            helperText={
                                                                                <>{touched.trade && touched.trade[index] && touched.trade[index].value &&
                                                                                errors.trade && errors.trade[index] && errors.trade[index]['value']}</>
                                                                            }
                                                                            ...
                                                                            InputProps={{
                                                                                endAdornment: <IconButton 
                                                                                    ...
                                                                                    onClick={() => { values.trade.length > 1 && arrayHelpers.remove(index)}}
                                                                                >
                                                                                    <DeleteIcon />
                                                                                </IconButton>
                                                                            }}
                                    ...
                                    <Grid container spacing={3}>
                                        ...
                                        <Grid item xl={6} lg={6} md={6} sm={6} xs={12}>
                                            <TextField
                                                ...
                                                label={<label>Teléfono <span style={{color: 'red'}}>*</span></label>}
                                                InputLabelProps={{
                                                    shrink: true
                                                }}
                                                name="phone"
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid item xl={4} lg={4} md={4} sm={4} xs={12}>
                                    <TextField
                                        ...
                                        helperText={touched.delivery && errors.delivery && 'Se requiere el 	Zona de reparto'}
                                        fullWidth
                                        SelectProps={{ native: true }}
                                        select
                                        onBlur={handleBlur}
                                    ...
                                    >
                                        ...
                                        <option selected key="1" value="1">{'A'}</option>
                                        <option selected key="2" value="2">{'B'}</option>
                                        <option selected key="3" value="3">{'C'}</option>
                                ...
                                <FieldArray
                                    ...
                                    render={arrayHelpers => (<>
                                        <Grid item xl={11} lg={11} sm={11} xs={11}>  
                                            <Grid container spacing={3}>
                                                <Grid  item xl={12} xs={12}>
                                                    <label style={{fontSize: 12.5, color: 'rgba(0, 0, 0, 0.54)'}}>&nbsp;&nbsp;&nbsp;&nbsp;Dirección</label>
                                                </Grid>
                                                            ...
                                                            <>
                                                                <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
                                                                    <TextField
                                                                        size="small"
                                                                        error={Boolean(
                                                                            touched.direction && touched.direction[index] && touched.direction[index].value &&
                                                                            errors.direction && errors.direction[index] && errors.direction[index]['value']
                                                                        )}
                                                                        fullWidth
                                                                        helperText={
                                                                            <>{touched.direction && touched.direction[index] && touched.direction[index].value &&
                                                                        ...
                                                                        InputProps={{
                                                                            endAdornment: <IconButton 
                                                                                ...
                                                                                color="primary" 
                                                                                aria-label="add to shopping cart"
                                                                                onClick={() => { values.direction.length > 1 && arrayHelpers.remove(index)}}
                                                                            >
                                                                                <DeleteIcon />
                                                                            </IconButton>
                                                                        }}
                                                                ...
                                                                <Grid item xl={3} lg={3} md={3} sm={3} xs={12}>
                                                                    <TextField
                                                                        size="small"
                                                                        label={<label>Departamento <span style={{color: 'red'}}>*</span></label>}
                                                                        name={`direction[${index}].department`}
                                                                        error={Boolean(
                                                                            touched.direction && touched.direction[index] && touched.direction[index].department &&
                                                                            errors.direction && errors.direction[index] && errors.direction[index]['department']
                                                                        )}
                                                                        helperText={
                                                                            <>{touched.direction && touched.direction[index] && touched.direction[index].department &&
                                                                            errors.direction && errors.direction[index] && errors.direction[index]['department']}</>
                                                                ...
                                                                <Grid item xl={3} lg={3} md={3} sm={3} xs={12}>
                                                                    <TextField
                                                                        size="small"
                                                                        label={<label>Provincia <span style={{color: 'red'}}>*</span></label>}
                                                                        name={`direction[${index}].province`}
                                                                        error={Boolean(
                                                                            touched.direction && touched.direction[index] && touched.direction[index].province &&
                                                                            errors.direction && errors.direction[index] && errors.direction[index]['province']
                                                                        )}
                                                                        helperText={
                                                                            <>{touched.direction && touched.direction[index] && touched.direction[index].province &&
                                                                            errors.direction && errors.direction[index] && errors.direction[index]['province']}</>
                                                                ...
                                                                <Grid item xl={3} lg={3} md={3} sm={3} xs={12}>
                                                                    <TextField
                                                                        size="small"
                                                                        label={<label>Distrito <span style={{color: 'red'}}>*</span></label>}
                                                                        name={`direction[${index}].district`}
                                                                        error={Boolean(
                                                                            touched.direction && touched.direction[index] && touched.direction[index].district &&
                                                                            errors.direction && errors.direction[index] && errors.direction[index]['district']
                                                                        )}
                                                                        helperText={
                                                                            <>{touched.direction && touched.direction[index] && touched.direction[index].district &&
                                                                            errors.direction && errors.direction[index] && errors.direction[index]['district']}</>
                                                                ...
                                                                <Grid item xl={3} lg={3} md={3} sm={3} xs={12}>
                                                                    <TextField
                                                                        size="small"
                                                                        label={<label>	Zona de reparto (Lima) <span style={{color: 'red'}}>*</span></label>}
                                                                        name={`direction[${index}].kind`}
                                                                        error={Boolean(
                                                                            touched.direction && touched.direction[index] && touched.direction[index].kind &&
                                                                            errors.direction && errors.direction[index] && errors.direction[index]['kind']
                                                                        )}
                                                                        helperText={
                                                                            <>{touched.direction && touched.direction[index] && touched.direction[index].kind &&
                                                                            errors.direction && errors.direction[index] && errors.direction[index]['kind']}</>
                                        ...
                                        <Grid item xl={1}  lg={1} sm={1} xs={1} >
                                            <IconButton 
                                                ...
                                                color="secondary" 
                                                aria-label="add to shopping cart"
                                                onClick={() => { arrayHelpers.push({id: -1, value: '', department: -1, province: -1, district: -1, kind: -1})}}
                                            >
                                                <AddIcon2 />
                                            </IconButton>
                                        </Grid>
                        ...
                        >
                            <Button variant="contained" color="primary" onClick={()=>handleModalOpen3()}>
                                Agregar
                            </Button>
                        </Box>
                            ...
                            <Table
                                ...
                                {paginatedContact.map((item, index) => {
                                    ...
                                    >
                                        ...
                                        <TableCell>
                                            {item.surname}{item.lastname}, {item.name}
                                        </TableCell>
                                        <TableCell>
                                            {item.email}
                                        </TableCell>
                                        <TableCell>
                                            {_getCargo(item.cargo)}
                                        </TableCell>
                                        <TableCell align="right">
